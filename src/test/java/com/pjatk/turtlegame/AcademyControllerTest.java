...
public class AcademyControllerTest extends BaseTest {
    ...
    @Test
    void seeIfCanTraining() throws Exception {

        MockHttpServletRequestBuilder request = get("/academy/if-training-can?trainingId=1&duration=180").with(user(firstUserDetails));
